...
const MOZ_BLOG_POSTS = {
  pt: [
    { title: "Conselho Municipal de Maputo avança com o plano estratégico para o encerramento seguro da Lixeira de Hulene", tag: "♻️ GESTÃO DE RESÍDUOS", img: "https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?auto=format&fit=crop&w=600&q=80", url: "https://africa.rtp.pt/noticias-africa/encerramento-da-lixeira-de-hulene-so-em-2028/" },
    { title: "FUNAE expande eletrificação rural em Nampula e Niassa recorrendo a mini-redes solares fotovoltaicas", tag: "⚡ ENERGIA SOLAR", img: "https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=600&q=80", url: "https://afroline.co.mz/2026/03/funae-preve-electrificar-151-localidades-com-energia-solar-em-nampula/" },
    { title: "BIOFUND financia a restauração em larga escala de ecossistemas de mangais nas áreas de conservação costeiras", tag: "🌿 BIODIVERSIDADE", img: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=600&q=80", url: "https://kambaku.net/biofund-3a-conferencia-da-biodiversidade-marinha-reforca-ligacao-de-ciencia-comunidades-e-estado/" },
    { title: "Reforço da monitoria das bacias hidrográficas dos rios Umbelúzi e Incomáti para prevenção de cheias", tag: "💧 RECURSOS HÍDRICOS", img: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=600&q=80", url: "https://mznews.co.mz/mocambique-defende-reforco-de-cooperacao-na-gestao-das-bacias-hidrograficas//" }
  ],
  en: [
